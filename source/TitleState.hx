		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 3:
					#if PSYCH_WATERMARKS
					addMoreText('TRSF', 15);
					addMoreText('Idiocrasy', 15);
					addMoreText('Infernoangel301', 15);
					addMoreText('PolybiusProxy', 15);
					#else
					addMoreText('present');
					#end
				// credTextShit.text += '\npresent...';
				...
				case 5:
					#if PSYCH_WATERMARKS
					createCoolText(['Very much associated', 'with'], -40);
					#else
